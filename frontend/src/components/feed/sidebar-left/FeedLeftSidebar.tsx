  ...
  return (
    <aside className="w-full hidden lg:block shrink-0 overflow-y-auto sticky top-[100px] h-[calc(100vh-100px)] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      <div className="w-full">
        <div className="mb-4">
          <div className="pt-6 pb-[6px] px-6 rounded-[6px] bg-white dark:bg-[#192D43] dark:text-white dark:border-[#384F68] mb-4">
            <h4 className="text-[20px] font-medium text-[#212121] dark:text-white mb-6 leading-[1.4]">
              Explore
            </h4>
            <ul className="m-0 p-0 list-none flex flex-col">
              <li className="mb-[24px]">
                <Link
                  href="#0"
                  className="flex items-center justify-between text-[16px] font-medium text-[#666666] dark:text-white/60 hover:text-[#1890FF] transition-colors leading-[1.4] group"
                >
                  <div className="flex items-center">
                    <svg
                      ...
                      fill="none"
                      viewBox="0 0 20 20"
                      className="mr-[14px] group-hover:text-[#1890FF] transition-colors"
                    >
                      <path
                        fill="currentColor"
                  ...
                  <span className="w-[36px] h-[24px] flex items-center justify-center font-normal text-[13px] leading-[1.4] text-white bg-[#0ACF83] border-[2px] border-white rounded-[8px]">
                    New
                  </span>
                </Link>
              </li>
              ...
              <li className="mb-[24px]">
                <Link
                  href="#0"
                  className="flex items-center text-[16px] font-medium text-[#666666] dark:text-white/60 hover:text-[#1890FF] transition-colors leading-[1.4] group"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22"
              ...
              <li className="mb-[24px]">
                ...
                >
                  <svg
                    ...
                    className="mr-[14px] text-[#666666] dark:text-white/60 group-hover:text-[#1890FF] transition-colors feather feather-users"
                  >
              ...
              <li className="mb-[18px]">
                <Link
                  href="#0"
                  className="flex items-center gap-[15px] text-[16px] font-medium text-[#666666] dark:text-white/60 hover:text-[#1890FF] transition-colors leading-[1.4] group"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    ...
                    fill="none"
                    viewBox="0 0 24 24"
                    className="text-[#666666] dark:text-white/60 group-hover:text-[#1890FF] transition-colors"
                  >
                    <path
                      fill="currentColor"
              ...
              <li className="mb-[18px]">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="text-[#666666] dark:text-white/60 group-hover:text-[#1890FF] transition-colors feather feather-save"
                  >
        ...
        <div className="mb-4">
          <div className="pt-6 pb-[6px] px-6 rounded-[6px] bg-white dark:bg-[#192D43] dark:text-white dark:border-[#384F68]">
            <div className="flex items-center justify-between mb-6">
              <h4 className="text-[20px] font-medium text-[#212121] dark:text-white leading-[1.4]">
                Suggested People
              </h4>
              <span className="text-[14px]">
                <Link className="text-[#1890FF] hover:underline" href="#0">
                  See All
                </Link>
              </span>
            </div>
              ...
              <div className="flex items-center justify-between mb-[18px]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    >
                      <h4 className="m-0 text-[16px] font-medium leading-[1.4]">
                        Steve Jobs
                      </h4>
                    </Link>
                    <p className="m-0 text-[12px] text-[#666666] dark:text-white/60 leading-[1.4] font-normal">
                      CEO of Apple
                    </p>
                  </div>
                </div>
                <div>
                  <Link
                    href="#0"
                    className="text-[12px] font-medium text-[#1890FF] px-[12px] py-[6px] rounded-[100px] border border-[#E5E5E5] hover:border-[#1890FF] transition-colors"
                  >
                    Connect
                  </Link>
                </div>
        ...
        <div className="mb-4">
          <div className="pt-[24px] pb-[6px] px-[24px] rounded-[6px] bg-white dark:bg-[#192D43] dark:text-white dark:border-[#384F68]">
            <div className="flex items-center justify-between mb-[16px]">
              ...
              <Link
                href="/event"
                className="text-[12px] font-medium text-[#1890FF] leading-[18px] py-[5px] block cursor-pointer"
              >
                See all
              </Link>
            </div>

            <Link href="/event-single" className="block cursor-pointer">
              <div className="bg-white dark:bg-[#192D43] dark:text-white dark:border-[#384F68] shadow-[0px_4px_8px_rgba(0,0,0,0.08)] rounded-[6px] mb-[16px] overflow-hidden">
                <div className="w-full">
                  <Image
                ...
                <div className="pt-[20px] pr-[16px] pb-[14px] pl-[16px] flex items-center">
                  <div className="bg-[#0ACF83] rounded-[2px] w-fit p-[8px] text-center shrink-0">
                    <p className="font-bold text-[18px] leading-[1.4] text-white">
                      10
                    </p>
                    <p className="font-normal text-[12px] leading-[1.4] text-white">
                      Jul
                    </p>
                  </div>
                  <div className="pt-[5px] pl-[8px]">
                    <h4 className="font-medium text-[16px] leading-[1.4] text-black dark:text-white">
                      No more terrorism no more cry
                    </h4>
                  </div>
                </div>
                <hr className="bg-[#F0F2F5] dark:bg-[#384F68] my-[4px] mb-[10px] border-none h-[1px]" />
                <div className="flex items-center justify-between pt-[2px] pr-[16px] pb-[12px] pl-[16px]">
                  <p className="font-medium text-[12px] leading-[18px] text-[#8A8A8A] dark:text-white/60 opacity-70">
                    17 People Going
                  </p>
                  <span className="block font-medium text-[12px] leading-[18px] text-[#1890FF] bg-[#F3F9FF] dark:bg-[rgba(24,144,255,0.1)] border border-[#1890FF] rounded-[2px] px-[14px] py-[3px] transition-all hover:text-white hover:bg-[#1890FF]">
                    Going
                  </span>
                </div>
              </div>
