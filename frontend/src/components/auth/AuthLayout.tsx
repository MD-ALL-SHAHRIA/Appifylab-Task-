...
export default function AuthLayout({ heroImage, header, googleButton, footer, children }: AuthLayoutProps) 
          ...
          <div className="flex flex-wrap items-center -mx-[15px]">
            ...
            <div className="w-full lg:w-1/3 px-[15px]">
              <div className="bg-white p-[48px] rounded-[6px]">
                ...
                {children}
                <AuthFooter text={footer.text} linkText={footer.linkText} href={footer.href} />
